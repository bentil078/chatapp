...
var appUser = "";
var usernames = {};
var availableRooms = ['General','Computing','Entertainment','Sports','Health','Department'];
...
app.get('/', (req,res) => {
	...
	if (appSession.loggedIn) {
		...
		res.render('index',{title:'LANChat'});
	}
...
app.get('/login', (req,res) => {
	...
	if (appSession.loggedIn) {
		...
		res.render('login',{title:'LANChat'});
	}
});
...
app.get('/signup', (req,res) => {
	...
	if (appSession.loggedIn) {
		...
		res.render('signup',{title:'LANChat'});
	}
});

//when the chatroom page is requested
app.get('/chatroom', (req,res) => {
	...
	if (!appSession.loggedIn) {
		...
		res.render('chatrooms',{title:'LANChat'});
	}
